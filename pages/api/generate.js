export default async function handler(req, res) {
  ...
  const systemPrompt = type === 'phone' ? getPhonePrompt(variation) : getPosterPrompt();
...
Then 2 sentences about specific visual details, colors, composition, and which rooms it suits.
Then add EXACTLY this block:
...
\ud83c\udf81 Perfect Gift For
[List 6-7 specific audience types based on the image], and [final type].
